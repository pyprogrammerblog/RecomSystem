...
def based_on_svd(ratings_df, products_df, name, corr_value):
    ...
    so in average each person recommend 10 product
    """
    ...
    # correlation matrix, we got 50x50, diagonal [[1, 0.2], [0.2, 1]]
    ...
    # get the correlation values of the product respect to the rest,
    # corr of the product with itself = 1
